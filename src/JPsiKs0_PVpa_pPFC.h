#ifndef _JPsiKs0_PVpa_pPFC_h
#define _JPsiKs0_PVpa_pPFC_h
...
class JPsiKs0_PVpa_pPFC : public edm::EDAnalyzer {
public:
  explicit JPsiKs0_PVpa_pPFC(const edm::ParameterSet&);
  ~JPsiKs0_PVpa_pPFC();
...
private:
  ...
  std::vector<int>         *muon1Trg, *muon2Trg;

  std::vector<int>         *just_test;
