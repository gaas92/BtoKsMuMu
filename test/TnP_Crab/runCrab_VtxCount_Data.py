...
def main():
    ...
    if options.crabCmd == 'submit':
        ...
        config.General.workArea = 'VtxCount_Data'
	config.General.transferOutputs = True
	config.General.transferLogs = False

        config.JobType.pluginName = 'Analysis'
	config.JobType.psetName = '/afs/cern.ch/work/g/gayalasa/public/B0Analysis/CMSSW_10_6_12/src/myAnalyzers/BtoKsMuMu/test/Run_VtxCount.py' #VtxCount configfile
   ...
   #     config.Data.totalUnits = 30
	...
	config.Data.outLFNDirBase = '/store/user/gayalasa/VtxCount_Data/'
