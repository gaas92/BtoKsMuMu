...
files_my_gen = [string for string in open('myGenFiles/Res_noProbeFilterDecayFilter_MiniAOD2_3.txt').readlines() if len(string) > 10]
...
process.TFileService = cms.Service("TFileService",
       ...
       fileName = cms.string('Rootuple_Bdtojpiks0_PARKED_Bpa_PVExt_MiniAOD_GEN_23.root'),
)
