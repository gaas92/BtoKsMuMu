...
files_my_gen = [string for string in open('myGenFiles/noProbeFilterDecayFilter_MiniAOD_2.txt').readlines() if len(string) > 10]
...
process.TFileService = cms.Service("TFileService",
       ...
       fileName = cms.string('Rootuple_BdtoMuMuks0_PARKED_Bpa_PVExt_MiniAOD_Gen2.root'),
)
