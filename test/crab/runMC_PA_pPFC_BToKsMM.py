...
def main():
    ...
    if options.crabCmd == 'submit':
        ...
        config.General.workArea = 'pPFC_nonResMC'
	config.General.transferOutputs = True
	config.General.transferLogs = False

        config.JobType.pluginName = 'Analysis'
	config.JobType.psetName = '/afs/cern.ch/work/g/gayalasa/public/B0Analysis/CMSSW_10_6_12/src/myAnalyzers/BtoKsMuMu/test/Psiks0_BestPA_pPFC_Rootupler.py' #MC Parked configfile
   ...
   #     config.Data.totalUnits = 30
	...
	config.Data.outLFNDirBase = '/store/user/gayalasa/pPFC_nonResMC/'
